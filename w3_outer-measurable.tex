...
\end{exercise}
\begin{exercise}
	Zeige, dass für jede Menge \(A\subseteq \real\) mit positivem äußerem Maß
	\(\mu^*(A)\ge 0\) eine nicht \(\mu^*\)-messbare Teilmenge existiert.
\end{exercise}
\begin{hint}
	Es gibt ein Intervall mit \(\mu^*(A\cap I)\ge 0\). O.B.d.A \(A=A\cap I\) und
	Vitali Mengen mit \(A\) schneiden und Subadditivität verwenden.
\end{hint}
