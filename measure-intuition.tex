...
\begin{solution}
	...
	Dann gilt
	\[
		\biguplus_{q\in\rational\cap[0,1]} V_q = [0,1]
	\]
	(überprüft Disjunktheit und Surjektivität) und \(\lambda(V_q)=\lambda(V)\),
	was zum geplanten Widerspruch führt. Die Vitali Mengen \(V_q\) können also
	nicht messbar sein.
\end{solution}
